          ...
          <div class="col-md-10 col-md-offset-1">
            ...
            ?>
              ...
              <div class="custom-col-3">
                  ...
                  <div class="right-col">
                      <?php if($video_link != ''){ ?><a href="<?php echo esc_url($video_link); ?>"><i class="fa fa-video-camera"></i></a><?php } ?>
                      <?php if($audio_link != ''){ ?><a href="<?php echo esc_url($audio_link); ?>"><i class="fa fa-volume-up"></i></a><?php } ?>
                      <?php if($file_link != ''){ ?><a href="<?php echo esc_url($file_link); ?>"><i class="fa fa-file-pdf-o"></i></a><?php } ?>
                  </div>
              </div>
